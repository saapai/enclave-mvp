    ...
    <div className="min-h-screen flex items-center justify-center bg-surface">
      <div className="w-full max-w-md p-6">
        <div className="text-center mb-8">
          ...
          <h1 className="hero-title text-primary mb-2">Welcome to Enclave</h1>
          <p className="hero-subtitle">The answer layer for your chapter. Please sign in to continue.</p>
        </div>
        <SignIn 
          appearance={{
            elements: {
