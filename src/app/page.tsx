      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl font-bold text-gray-900">Welcome to Enclave</CardTitle>
            <CardDescription>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-gray-900">Enclave</h1>
        ...
        <Tabs defaultValue="search" className="w-full">
          ...
          <TabsContent value="search" className="mt-6">
            {results.length > 0 ? (
              ...
              <div className="text-center py-12">
                <div className="text-gray-500 mb-4">Start typing to search for information</div>
          ...
          <TabsContent value="requests" className="mt-6">
            <div className="text-center py-12">
              <div className="text-gray-500 mb-4">No open requests</div>
              <div className="text-sm text-gray-400">
