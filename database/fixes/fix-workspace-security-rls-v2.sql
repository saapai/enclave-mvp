...
-- VERSION 2: Fixed type casting issue
...
DROP POLICY IF EXISTS "authenticated_workspace_members" ON resource;
...
DROP POLICY IF EXISTS "authenticated_workspace_members" ON space;
...
DROP POLICY IF EXISTS "authenticated_workspace_members" ON app_user;
...
DROP POLICY IF EXISTS "authenticated_workspace_members" ON google_docs_chunks;
...
DROP POLICY IF EXISTS "authenticated_workspace_members" ON calendar_events_chunks;
...
DROP POLICY IF EXISTS "authenticated_workspace_members" ON resource_embedding;
