-- Improve FTS ranking by weighting title matches higher than body matches
-- This ensures that a resource titled "Active Meeting" ranks higher than
-- a generic doc that mentions "active" and "meeting" in the body
